...
@property (nonatomic, strong, nullable) NSArray<MPRouteNetwork*>*                 networks;
@property (nonatomic, strong, nullable) NSDictionary<NSString*,MPRouteNetwork*>*  networkFromGraphId;         // keys are *always* lowercase
