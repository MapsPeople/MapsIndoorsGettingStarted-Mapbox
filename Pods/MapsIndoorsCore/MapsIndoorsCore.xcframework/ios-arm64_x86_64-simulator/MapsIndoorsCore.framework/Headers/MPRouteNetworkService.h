...
+ (BOOL) getRouteNetworkForSolution:(nonnull NSString*)solutionId venueId:(nonnull NSString*)venueId completion:(nonnull void(^)(MPRouteNetworkData* _Nullable,NSError* _Nullable))completion;

+ (void) getRouteNetworkForSolutionAsync:(nonnull NSString*)solutionId completion:(nonnull void(^)(MPRouteNetworkData* _Nullable,NSError* _Nullable))completion;

+ (void) getRouteNetworkForSolutionAsync:(nonnull NSString*)solutionId venueId:(nonnull NSString*)venueId completion:(nonnull void(^)(MPRouteNetworkData* _Nullable,NSError* _Nullable))completion;
