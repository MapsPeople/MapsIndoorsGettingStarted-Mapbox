...
+ (instancetype) newWithNodes :(NSArray<MPGraphNode*>*)nodes edges:(NSArray<MPGraphEdge*>*)edges entryPointNodes:(nullable NSArray<MPGraphNode*>*)entryPointNodes;
- (instancetype) initWithNodes:(NSArray<MPGraphNode*>*)nodes edges:(NSArray<MPGraphEdge*>*)edges entryPointNodes:(nullable NSArray<MPGraphNode*>*)entryPointNodes;
